export function Hero() {
  return `
    <section id="inicio" class="relative mx-auto max-w-4xl px-4 sm:px-6 pt-16 pb-20 text-center flex flex-col items-center justify-center overflow-hidden">
      ...
      <div class="glow-blob w-[500px] h-[500px] bg-indigo-500/15 -top-20 left-1/2 -translate-x-1/2"></div>
      ...
      <div class="relative z-10 space-y-8 max-w-3xl mx-auto">
        ...
        <!-- Bio Paragraph -->
        <p class="text-base sm:text-lg leading-relaxed text-slate-300 max-w-2xl mx-auto">
          Apasionado por el desarrollo web fullstack. Trabajo creando interfaces modernas y sistemas robustos utilizando 
          <span class="font-bold text-white">Laravel 12, Vue.js, PHP, JavaScript</span>, e integración de 
          <span class="font-bold text-white">Inteligencia Artificial</span> con bases de datos 
          <span class="font-bold text-white">MySQL y PostgreSQL</span>.
        </p>

        <!-- Tech Stack Badges (WITH UNIQUE CLASS hero-tech-badge TO PREVENT GSAP DISAPPEARING BUG) -->
        <div class="flex flex-wrap items-center justify-center gap-2.5 pt-2">
          <span class="hero-tech-badge px-3.5 py-2 rounded-xl glass-card text-xs font-bold text-slate-200 flex items-center gap-2 border border-slate-800 shadow-sm">
        ...
        <!-- Action Buttons (WITHOUT ICONS INSIDE BUTTONS) -->
        <div class="flex flex-wrap items-center justify-center gap-4 pt-4">
          ...
          <a
            href="#contacto"
            class="px-8 py-4 rounded-2xl glass-card text-slate-200 font-bold text-sm hover:border-indigo-500/50 hover:scale-105 active:scale-95 transition-all text-center"
          >
            Contacto
          </a>
          <a
            href="CV.pdf"
            target="_blank"
            class="px-8 py-4 rounded-2xl border border-slate-700 bg-transparent text-slate-300 font-bold text-sm hover:bg-slate-800/50 hover:scale-105 active:scale-95 transition-all text-center"
          >
            Visualizar CV
          </a>
        </div>
        ...
        <div class="pt-6 w-full max-w-2xl mx-auto">
          <div class="glass-card rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-xl text-center space-y-4">
            <div class="grid sm:grid-cols-2 gap-4 text-left">
              <div class="p-4 rounded-2xl bg-slate-800/60 border border-slate-700/60">
                <span class="text-[10px] font-black uppercase tracking-widest text-indigo-400 block mb-1">
                  Grado Académico
                </span>
